...
csv.output.filename <- file.path("DATA","OUTPUT","result_model_glm_all_clusters_shopping_2_A.csv")
RData.output.filename <- file.path("DATA","OUTPUT","first_model_glm_all_clusters_shopping_2_A.RData")
...
source(file.path("templates","get_data_glm_model_with_error_shopping_2.R"))
