...
csv.output.filename <- file.path("DATA","OUTPUT","result_model_glm_all_clusters_A.csv")
RData.output.filename <- file.path("DATA","OUTPUT","first_model_glm_all_clusters_A.RData")
