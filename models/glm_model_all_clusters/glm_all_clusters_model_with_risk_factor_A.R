...
csv.output.filename <- file.path("DATA","OUTPUT","result_model_glm_all_clusters_with_risk_factor_A.csv")
RData.output.filename <- file.path("DATA","OUTPUT","first_model_glm_all_clusters_with_risk_factor_A.RData")
...
source(file.path("templates","get_data_glm_model_with_error_with_risk_factor.R"))
