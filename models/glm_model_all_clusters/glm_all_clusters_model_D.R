...
csv.output.filename <- file.path("DATA","OUTPUT","result_model_glm_all_clusters_D.csv")
RData.output.filename <- file.path("DATA","OUTPUT","first_model_glm_all_clusters_D.RData")
