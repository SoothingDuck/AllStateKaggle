...
write.csv(dataTrainBase, file=file.path("DATA","train_first_model_prediction_v3.csv"))
write.csv(dataTestBase, file=file.path("DATA","test_first_model_prediction_v3.csv"))
...
submission.filename <- file.path("DATA", "first_model_submission_v3.csv")
