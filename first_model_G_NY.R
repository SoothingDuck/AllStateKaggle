...
data <- subset(data, state == "NY")
data <- data[,! colnames(data) == "state"]
...
save(
  ...
  model_2_final_G_NY, 
  model_3_final_G_NY, 
  model_4_final_G_NY, file=file.path("DATA","OUTPUT","first_model_G_NY.RData"))
