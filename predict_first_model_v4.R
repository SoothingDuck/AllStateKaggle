...
write.csv(dataTrainBase, file=gzfile(file.path("DATA","train_first_model_prediction_v4.csv.gz")))
write.csv(dataTestBase, file=gzfile(file.path("DATA","test_first_model_prediction_v4.csv.gz")))
...
submission.filename <- file.path("DATA", "first_model_submission_v4.csv")
